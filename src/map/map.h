...
enum {
	...
	MAPID_DRAGON_KNIGHT   = JOBL_FOURTH | MAPID_RUNE_KNIGHT,
	MAPID_ARCH_MAGE       = JOBL_FOURTH | MAPID_WARLOCK,
	MAPID_WINDHAWK        = JOBL_FOURTH | MAPID_RANGER,
	MAPID_CARDINAL        = JOBL_FOURTH | MAPID_ARCH_BISHOP,
	MAPID_MEISTER         = JOBL_FOURTH | MAPID_MECHANIC,
	MAPID_SHADOW_CROSS    = JOBL_FOURTH | MAPID_GUILLOTINE_CROSS,
	MAPID_SKY_EMPEROR     = JOBL_FOURTH | MAPID_STAR_EMPEROR,
	MAPID_NIGHT_WATCH     = JOBL_FOURTH | MAPID_REBELLION,
	MAPID_SHINKIROSHIRANUI = JOBL_FOURTH | MAPID_KAGEROUOBORO,
	MAPID_SPIRIT_HANDLER  = JOBL_FOURTH | MAPID_SUMMONER,

	// 4-2 Jobs
	MAPID_IMPERIAL_GUARD      = JOBL_FOURTH | MAPID_ROYAL_GUARD,
	MAPID_ELEMENTAL_MASTER    = JOBL_FOURTH | MAPID_SORCERER,
	MAPID_TROUBADOURTROUVERE = JOBL_FOURTH | MAPID_MINSTRELWANDERER,
	MAPID_INQUISITOR          = JOBL_FOURTH | MAPID_SURA,
	MAPID_BIOLO               = JOBL_FOURTH | MAPID_GENETIC,
	MAPID_ABYSS_CHASER        = JOBL_FOURTH | MAPID_SHADOW_CHASER,

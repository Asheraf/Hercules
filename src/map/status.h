...
enum _scb_flag
{
	...
	CONST_OR_ENUMVAL(SCB_MAXAP,     0x1000000000)
	CONST_OR_ENUMVAL(SCB_POW,       0x2000000000)
	CONST_OR_ENUMVAL(SCB_STA,       0x4000000000)
	CONST_OR_ENUMVAL(SCB_WIS,       0x8000000000)
	CONST_OR_ENUMVAL(SCB_SPL,       0x10000000000)
	CONST_OR_ENUMVAL(SCB_CON,       0x20000000000)
	CONST_OR_ENUMVAL(SCB_CRT,       0x40000000000)
	CONST_OR_ENUMVAL(SCB_PATK,      0x80000000000)
	CONST_OR_ENUMVAL(SCB_SMATK,     0x100000000000)
	CONST_OR_ENUMVAL(SCB_RES,       0x200000000000)
	CONST_OR_ENUMVAL(SCB_MRES,      0x400000000000)
	CONST_OR_ENUMVAL(SCB_HPLUS,     0x800000000000)
	CONST_OR_ENUMVAL(SCB_CRATE,     0x1000000000000)

	CONST_OR_ENUMVAL(SCB_BATTLE,    0x1FFFF3FFFFFFE)
	CONST_OR_ENUMVAL(SCB_ALL,       0x1FFFF3FFFFFFF)
#ifndef _MSC_VER
};
#endif
...
#define status_get_patk(bl)                  (status->get_status_data(bl)->patk)
#define status_get_smatk(bl)                 (status->get_status_data(bl)->smatk)
#define status_get_res(bl)                   (status->get_status_data(bl)->res)
#define status_get_mres(bl)                  (status->get_status_data(bl)->mres)
#define status_get_hplus(bl)                 (status->get_status_data(bl)->hplus)
#define status_get_crate(bl)                 (status->get_status_data(bl)->crate)

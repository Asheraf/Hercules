...
enum ai {
	...
	AI_BIONIC,   //5: Biolo Bionic Summon
	AI_ABR,      //6: Meister ABR Summon
...
enum mob_id {
	...
	MOBID_BIONIC_WOODENWARRIOR = 20848, ///< SUMMON_WOODENWARRIOR / Wooden Warrior
	MOBID_BIONIC_WOODEN_FAIRY = 20849, ///< SUMMON_WOODEN_FAIRY / Wooden Fairy
	MOBID_BIONIC_CREEPER   = 20850, ///< SUMMON_CREEPER / Creeper
	MOBID_BIONIC_HELLTREE  = 20851, ///< SUMMON_HELLTREE / Hell Tree

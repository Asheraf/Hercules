...
#define MAX_SKILL_NAME_LENGTH     40
...
enum {
	...
	UNT_ICE_PILLAR = 0x139,
	UNT_GLACIAL_MONOLITH,

	UNT_STAR_BURST = 0x969,

	// Skill units outside the normal unit range.
	UNT_DEEPBLINDTRAP = 0x5174,
	UNT_SOLIDTRAP,
	UNT_SWIFTTRAP,
	UNT_FLAMETRAP,
...
struct skill_interface {
	...
	void (*add_thundering_charge) (struct block_list *src, uint16 skill_id, uint16 skill_lv, int charge);
	int (*gravity_hole_sub) (struct block_list *bl, va_list ap);

...
JOB_ENUM_VALUE(DRAGON_KNIGHT, 4252, JOB_DRAGON_KNIGHT)
JOB_ENUM_VALUE(MEISTER, 4253, JOB_MEISTER)
JOB_ENUM_VALUE(SHADOW_CROSS, 4254, JOB_SHADOW_CROSS)
JOB_ENUM_VALUE(ARCH_MAGE, 4255, JOB_ARCH_MAGE)
JOB_ENUM_VALUE(CARDINAL, 4256, JOB_CARDINAL)
JOB_ENUM_VALUE(WINDHAWK, 4257, JOB_WINDHAWK)
JOB_ENUM_VALUE(IMPERIAL_GUARD, 4258, JOB_IMPERIAL_GUARD)
JOB_ENUM_VALUE(BIOLO, 4259, JOB_BIOLO)
JOB_ENUM_VALUE(ABYSS_CHASER, 4260, JOB_ABYSS_CHASER)
JOB_ENUM_VALUE(ELEMENTAL_MASTER, 4261, JOB_ELEMENTAL_MASTER)
JOB_ENUM_VALUE(INQUISITOR, 4262, JOB_INQUISITOR)
JOB_ENUM_VALUE(SKY_EMPEROR, 4302, JOB_SKY_EMPEROR)
JOB_ENUM_VALUE(SOUL_ASCETIC, 4303, JOB_SOUL_ASCETIC)
JOB_ENUM_VALUE(NIGHT_WATCH, 4306, JOB_NIGHT_WATCH)
JOB_ENUM_VALUE(HYPER_NOVICE, 4307, JOB_HYPER_NOVICE)
JOB_ENUM_VALUE(SPIRIT_HANDLER, 4308, JOB_SPIRIT_HANDLER)
JOB_ENUM_VALUE(DRUID, 4351, JOB_DRUID)
JOB_ENUM_VALUE(BABY_DRUID, 4352, JOB_BABY_DRUID)
JOB_ENUM_VALUE(KARNOS, 4353, JOB_KARNOS)
JOB_ENUM_VALUE(BABY_KARNOS, 4354, JOB_BABY_KARNOS)
JOB_ENUM_VALUE(ALITEA, 4355, JOB_ALITEA)

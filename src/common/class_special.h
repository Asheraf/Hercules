...
JOB_ENUM_VALUE(TROUBADOUR, 4263, JOB_TROUBADOUR)
JOB_ENUM_VALUE(TROUVERE, 4264, JOB_TROUVERE)
JOB_ENUM_VALUE(SHINKIRO, 4304, JOB_SHINKIRO)
JOB_ENUM_VALUE(SHIRANUI, 4305, JOB_SHIRANUI)
